 ...
 * under the License.
 */
package br.com.personality.insights.portal.security;
 ...
 * @since 0.2
 */
public class InsightsSecurityRealm extends AuthorizingRealm {
     ...
     */
    protected static final String DEFAULT_AUTHENTICATION_QUERY = "select senha from $ds_schema.usuario where email = ? or login = ?";
    
    /**
     * The default query used to retrieve account data for the user when {@link #saltStyle} is COLUMN.
     */
    protected static final String DEFAULT_SALTED_AUTHENTICATION_QUERY = "select senha, login from $ds_schema.usuario where email = ? or login = ?";

    /**
     * The default query used to retrieve the roles that apply to a user.
     */
    protected static final String DEFAULT_USER_ROLES_QUERY = "select grupo_usuario_id from $ds_schema.usuarios_grupos_usuario where usuario_id = (select id from $ds_schema.usuario where email = ? or login = ?)";

    /**
     * The default query used to retrieve permissions that apply to a particular role.
     */
    protected static final String DEFAULT_PERMISSIONS_QUERY = "select componente_id from $ds_schema.grupo_usuario_componente where grupo_usuario_id = ?";

    private static final Logger log = LoggerFactory.getLogger(InsightsSecurityRealm.class);
